...
const mainNavItems = [
  ...
  { text: 'Orders', icon: <ShoppingCartIcon />, path: '/agent/orders' },
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        <Toolbar sx={{ justifyContent: 'space-between' }}>
          ...
          >
            {location.pathname === '/agent/dashboard' ? 'Dashboard' : 
             location.pathname === '/agent/orders' ? 'Orders' : 
             location.pathname === '/agent/settings' ? 'Settings' : 'Agent Portal'}
          </Typography>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            >
              <MenuItem onClick={() => { handleNavigate('/agent/profile'); handleMenuClose(); }}>
                <ListItemIcon>
